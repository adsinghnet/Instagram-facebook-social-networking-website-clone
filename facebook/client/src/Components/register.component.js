    ...
    return (
        ...
        <div className="container-sm px-4 w-50">
            ...
            <form className="margin box " onSubmit={register}>
                ...
                <h1 className=" text-center fs-3 text-wrap text-secondary">Sign up to see photos and videos from your friends.</h1>
                ...
                <p className=" text-center fs-10 text-wrap text-secondary">By signing up, you agree to our Terms , Data Policy and Cookies Policy .</p>
            </form>
        </div>
    )
}
