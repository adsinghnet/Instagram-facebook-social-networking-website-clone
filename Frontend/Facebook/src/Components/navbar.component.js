    ...
    return (
        <nav className="navbar nav-effect bg-white text-dark">
            <div className="container">
                <Link to="/" className="nav-logo"><img src={logonav} className="img-fluid px-0 py-0" alt="Logo" /></Link>
                <ul className="nav-list" id="nav-list">
                    {PP === null
                        ? <NavLink to={`/u/${username}`} className="link text primary"><li className="nav-item"><img src={profileLogo} alt="Profile Icon" className="logo" /><span className="nav-item-description">Profile</span></li></NavLink>
                        : <NavLink to={`/u/${username}`} className="link text primary"><li className="nav-item"><img src={PP} alt="Profile Icon" className="logo" /><span className="nav-item-description">Profile</span></li></NavLink>
                    }
                    {isLoggedIn
