...
const EditPost = (params) => {
    ...
    return (
        <div className="container">
            {isOwner ?
                [(postInfo
                    ? <form className="margin box box-shadow container-sm px-4 w-50" onSubmit={Submit} key={postInfo.description}>
                        <p className="form-error">{error}</p>
                        <div className="form-group">
                            <img src={`${BACKEND_URL}/${postInfo.image.filename}`} alt={postInfo.description} className="box-image col-md-4" />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            <input className="form-control btn btn-outline-primary my-4" type="submit" />
                        </div>
                    </form>
