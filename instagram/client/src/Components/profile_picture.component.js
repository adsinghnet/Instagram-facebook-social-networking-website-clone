        ...
        <div className="container my-5">
            <div className="margin box box-shadow bg-dark text-light">
                ...
                <label htmlFor="upload-profile-picture">
                    <div className="d-flex justify-content-center mx-auto col-md-4">
                        {file === null
                            ? <img src={profile} alt="Profile Logo" className=" img-fluid px-0 py-0 img-thumbnail rounded mx-auto d-block" />
                            : <img src={file} alt="Profile Logo" className=" img-fluid px-0 py-0 img-thumbnail rounded mx-auto d-block" />}
                    </div>
